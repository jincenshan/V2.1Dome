<template>
  <div class="app-container">
    <div class="block">
      ...
      <el-input v-model="inOrderNo" class="input_class" placeholder="支付订单号" clearable/>
      <el-input v-model="outOrderNo" class="input_class" placeholder="第三方订单号" clearable/>
      <div>
      ...
      <el-select v-model="type" clearable placeholder="付费项目" style="margin-left: 10px;width: 130px">
        <el-option
    ...
    >
      ...
      <el-table-column label="付款人" width="110" align="center">
      ...
      <el-table-column class-name="status-col" label="付费项目" width="110" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.type =='INSTALL'">安装费</span>
          <span v-if="scope.row.type =='ENTER_HOUSE'">入户费</span>
        </template>
      </el-table-column>
      <el-table-column class-name="status-col" label="付款金额" width="110" align="center">
...
<!--      </el-table-column>-->
      ...
      <el-table-column class-name="status-col" label="支付订单号" width="180" align="center">
        <template slot-scope="scope">
          {{scope.row.orderNo}}
        </template>
      </el-table-column>
      <el-table-column class-name="status-col" label="第三方支付订单号" width="180" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column class-name="status-col" label="付款成功时间" width="180" align="center">
        <template slot-scope="scope">
          <i class="el-icon-time"/>
...
<script>
  import {houseList} from '@/api/table'
    ...
    methods: {
      ...
      exportExcel() {
        var params = {
          ...
          excelColumn: ['id', 'netName', 'area', 'consumerName', 'phone', 'terminalSn', 'type', 'amount', 'status', 'outOrderNo', 'channel', 'settlement', 'createDate', 'payDate'],
          excelHead: ["订单ID", "网点名称", "所在地区", "付款人", "付款账号", "入户终端SN", "付费项目", "付款金额", "订单状态", "微信支付订单号", "支付渠道", "分账状态", "创建时间", "付款成功时间"],
          export: true,
          productLine: "OXY",
          token: getToken(),
        }
