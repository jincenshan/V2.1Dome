<template>
  <div class="app-container">
    <div class="block">
      ...
      <el-select v-model="modelId" clearable placeholder="按入户终端型号" style="width: 150px">
        <el-option
      ...
      <el-select v-model="productLine" clearable placeholder="请选择产品线"
    ...
    >
      ...
      <el-table-column label="操作" align="center" fixed="right" width="200">
        <template slot-scope="scope">
          ...
          <el-button style="padding: 0px;" type="text" size="small" @click="historyShow(scope.row)" v-if="buttonArray.includes('up_hs_n')">历史记录</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    methods: {
      ...
      exportExcel() {
        var params = {
          ...
          excelColumn: ['id', 'snNo', 'optName', 'netName', 'equipName', 'modelName', 'productLine', 'totalOxyOutput', 'useTotalDuration', 'continuousUseDuration', 'instantFlow', 'status', 'runningState','activationDate', 'modifyDate'],
          excelHead: ["终端ID", "终端SN", "当前所属运营商", "所驻网点", "设备名称", "终端设备型号", "产品线", "累计出氧量(L)", "总运行时长（h）", "连续运行时长（min）","瞬时流量(L/min)", "设备使用状态", "设备运行状态","激活时间", "最近一次更新时间"],
          export: true,
        }
