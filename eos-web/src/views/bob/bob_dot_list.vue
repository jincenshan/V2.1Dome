...
<!--      </span></button>-->
    ...
    >
      ...
      <el-table-column class-name="status-col" label="账号" width="110" align="center">
      ...
      <el-table-column label="操作" align="center" fixed="right" width="250">
        <template slot-scope="scope">
          <el-button type="text" size="small" v-if='buttonArray.includes("bob_dot_detail")' @click="handleClick(scope.row)">网点详情</el-button>
          <el-button type="text" size="small" @click="goOxygen(scope.row)">运营状态</el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  methods: {
    ...
    exportExcel() {
      var params = {
        ...
        excelColumn: ['id', 'name', 'area', 'contacts', 'phone', '','', 'terminalType', 'productLine', 'payType', 'createDate'],
        excelHead: ["网点编号", "网点名称", "所在地区", "联系人", "联系人电话","制氧机台数", "订单数", "终端类型", "产品线", "付费类型", "网点创建时间"],
        export: true,
      }
